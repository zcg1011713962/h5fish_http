...
{
    private static string[] s_head = new string[] {"日期", "渠道", "注册", "设备激活", "活跃","设备活跃", "收入", "平均每个设备生成账号", "付费人数", "付费次数",
        "次日留存率", "3日留存率", "7日留存率" ,"30日留存率", "ARPU", "ARPPU", "付费率",
        "非新增首次付费次数","新增付费人数","新增用户付费", "新增ARPPU","新增用户付费率","次日付费率",
...
{
    private static string[] s_head = new string[] { "日期", "欢乐浅滩（道具使用）", "深海巨鳄", "大圣降临", "海王宝藏", "龙王传说","武装巨鲨" };
    ...
    public void genTable(GMUser user, Table table, OpRes res,string r)
    {
        ...
        int[] roomIds = new int[] {1,2,3,4,5, 6};
