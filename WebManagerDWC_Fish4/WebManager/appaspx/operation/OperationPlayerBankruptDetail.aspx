<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OperationPlayerBankruptDetail.aspx.cs" Inherits="WebManager.appaspx.operation.OperationPlayerBankruptDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  style="background-color:#ccc;width:90%;margin:0 auto;text-align:center">
        <div class="cSafeWidth">
            <h2 style="text-align:center;padding:20px;">破产统计详情</h2>
