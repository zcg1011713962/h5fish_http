<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatNationalDayActLotteryDetail.aspx.cs" Inherits="WebManager.appaspx.stat.StatNationalDayActLotteryDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  style="background-color:#ccc;width:90%;margin:0 auto; text-align:center">
        <div class="cSafeWidth" style="width:90%">
            <h2 style="text-align:center;padding:20px;">十一活动抽奖统计详情</h2>
