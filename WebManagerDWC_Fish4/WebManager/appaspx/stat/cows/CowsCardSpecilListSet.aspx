<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="CowsCardSpecilListSet.aspx.cs" Inherits="WebManager.appaspx.stat.cows.CowsCardSpecilListSet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../../../Scripts/stat/CowsCardSpecilList.js?ver=2" type="text/javascript"></script>
    <style type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth">
        <h2 style="text-align:center;padding:20px;">牛牛拉入黑白名单设置</h2>
