<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="StatNewSevenDay.aspx.cs" Inherits="WebManager.appaspx.stat.StatNewSevenDay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">七日礼包</h2>
      ...
      <div style="margin-top:10px;text-align:center;margin:0 10%;">
