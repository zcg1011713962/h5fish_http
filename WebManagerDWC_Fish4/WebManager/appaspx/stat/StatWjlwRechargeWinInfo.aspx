<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatWjlwRechargeWinInfo.aspx.cs" Inherits="WebManager.appaspx.stat.StatWjlwRechargeWinInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="background-color: #ccc; width: 90%; margin: 0 auto;text-align:center">
        <div class="cSafeWidth">
            <h2 style="padding: 20px;">围剿龙王付费玩法获奖详情</h2>
