<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="StatHallowmasActivity.aspx.cs" Inherits="WebManager.appaspx.stat.StatHallowmasActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">万圣节活动</h2>
        ...
        <div class="form-group"id="pumpkinCount">
            <label for="account" class="col-sm-2 control-label">南瓜数量：</label>
            <div class="col-sm-10">
                <asp:TextBox ID="m_pumpkinCount" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
