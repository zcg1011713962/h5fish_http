<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="CrocodileSpecilListSet.aspx.cs" Inherits="WebManager.appaspx.stat.crocodile.CrocodileSpecilListSet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../../../Scripts/stat/CrocodileSpecilListSet.js?ver=2" type="text/javascript"></script>
    <style type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth">
        <h2 style="text-align:center;padding:20px;">鳄鱼大亨拉入黑白名单设置</h2>
