...
namespace WebManager.appaspx.stat.fish
{
    ...
    {
        private static string[] s_head = new string[] { "日期","场次","BOSS名称", "BOSS出现次数", "BOSS死亡次数", "金币消耗", "放出碎片",
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                m_bossList.Items.Add(new ListItem("变倍章鱼", "21"));
                m_bossList.Items.Add(new ListItem("元宝龟", "701"));
                m_bossList.Items.Add(new ListItem("深海巨鳄", "702"));
                m_bossList.Items.Add(new ListItem("大圣", "703"));
                m_bossList.Items.Add(new ListItem("海王", "704"));
                m_bossList.Items.Add(new ListItem("龙王", "705"));
                m_bossList.Items.Add(new ListItem("武装巨鲨", "706"));
            }
        }
