        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (gameId)
            {
                ...
                case (int)GameId.dragon:
                    {
                        Server.Transfer(string.Format(DefCC.ASPX_GAME_DETAIL_DRAGON, indexStr));
                    }
                    break;
                case (int)GameId.shuihz:
                    {
                        Server.Transfer(string.Format(DefCC.ASPX_GAME_DETAIL_SHUIHZ, indexStr));
                    }
                    break;
                ...
                case (int)GameId.bz:
                    {
                        Server.Transfer(string.Format(DefCC.ASPX_GAME_DETAIL_BZ, indexStr));
                    }
                    break;
                case (int)GameId.fruit:
                    {
                        Server.Transfer(string.Format(DefCC.ASPX_GAME_DETAIL_FRUIT, indexStr));
                    }
                    break;
                case (int)GameId.jewel:
                    {
                        Server.Transfer(string.Format(DefCC.ASPX_GAME_DETAIL_JEWEL, indexStr));
                    }
                    break;
            }
        }
