<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatGoldFishLottery.aspx.cs" Inherits="WebManager.appaspx.stat.StatGoldFishLottery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal" style="width:80%">
        <h2 style="padding:20px;text-align:center">幸运抽奖</h2>
        ...
        <div class="form-group">
            <label for="account" class="col-sm-2 control-label">抽奖类型:</label>
            <div class="col-sm-10">
                <asp:DropDownList ID="m_lotteryId" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>
        </div>       
