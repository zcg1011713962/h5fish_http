<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatKillCrabActLotteryDetail.aspx.cs" Inherits="WebManager.appaspx.stat.StatKillCrabActLotteryDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  style="background-color:#ccc;width:90%;margin:0 auto; text-align:center">
        <div class="cSafeWidth">
            <h2 style="text-align:center;padding:20px;">追击蟹将抽奖统计玩家列表</h2>
