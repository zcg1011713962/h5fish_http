<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="BzSpecilListSet.aspx.cs" Inherits="WebManager.appaspx.stat.bz.BzSpecilListSet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../../../Scripts/stat/BzSpecilListSet.js?ver=2" type="text/javascript"></script>
    <style type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth">
        <h2 style="text-align:center;padding:20px;">奔驰宝马拉入黑白名单设置</h2>
