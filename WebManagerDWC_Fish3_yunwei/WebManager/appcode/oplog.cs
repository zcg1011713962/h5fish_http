...
class LogModifyFishlordCtrlNewParam : OpParam
{
    ...
    public LogModifyFishlordCtrlNewParam(int roomId, double jsckpotGrandPump, double jsckpotSmallPump, double normalFishRoomPoolPumpParam, double baseRate,
        double checkRate, double trickDeviationFix, long incomeThreshold,double earnRatemCtrMax,double earnRatemCtrMin, int legendaryFishRate,
        int mythicalScoreTurnRate, int mythicalFishRate)
    {
        m_roomId = roomId;
    ...
    public override string getDescription(OpInfo info, string str)
    {
        ...
        if (param != null) 
        {
            ...
            strinfo += "控制范围上限 [" + param.m_earnRatemCtrMax + "]，控制范围下限 [" + param.m_earnRatemCtrMin +
