<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TdActivationOfOldPlayer.aspx.cs" Inherits="WebManager.appaspx.td.TdActivationOfOldPlayer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth">
        <h2 style="padding:20px;text-align:center">留存相关——老用户</h2>
