    ...
    <div class="cSafeWidth">
        ...
        <table style="margin: 0 auto">
            ...
            <tr>
                <td>付费点：</td>
                <td>
                    <asp:DropDownList ID="m_rechargePoint" runat="server"></asp:DropDownList></td>
            </tr>
            <tr>
                <td>充值范围：</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="Button2" runat="server" OnClick="onStatRecharge" Text="统计" Style="width: 100px; height: 30px;display:none" />
                    <asp:Button ID="Button3" runat="server" OnClick="onExport" Text="导出Excel" Style="width: 100px; height: 30px;display:none" />
                    <asp:Button ID="btn" runat="server" OnClick="onQueryByAibei" Text="通过爱贝充值查询" Style="width: 130px; height: 30px;display:none" />
                </td>
            </tr>
        </table>
    </div>
