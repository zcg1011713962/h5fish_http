<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="CowsCardsQuery.aspx.cs" Inherits="WebManager.appaspx.stat.cows.CowsCardsQuery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">牛牛牌局查询</h2>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label for="account" class="col-sm-2 control-label">坐庄者筛选：</label>
            <div class="col-sm-10">
