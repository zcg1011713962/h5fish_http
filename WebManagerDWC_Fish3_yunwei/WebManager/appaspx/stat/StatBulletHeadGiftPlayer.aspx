<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatBulletHeadGiftPlayer.aspx.cs" Inherits="WebManager.appaspx.stat.StatBulletHeadGiftPlayer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="background-color: #ccc; width: 90%; margin: 0 auto;text-align:center">
        <div class="cSafeWidth">
            <h2 style="padding: 20px;">弹头礼包统计详情</h2>
