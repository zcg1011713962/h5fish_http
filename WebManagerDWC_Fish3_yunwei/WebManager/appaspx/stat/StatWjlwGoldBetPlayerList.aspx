<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatWjlwGoldBetPlayerList.aspx.cs" Inherits="WebManager.appaspx.stat.StatWjlwGoldBetPlayerList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="background-color: #ccc; width: 90%; margin: 0 auto;text-align:center">
        <div class="cSafeWidth">
            <h2 style="padding: 20px;">金币玩法每局下注玩家列表</h2>
