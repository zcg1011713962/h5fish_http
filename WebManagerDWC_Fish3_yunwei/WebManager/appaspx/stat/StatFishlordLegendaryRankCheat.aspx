<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatFishlordLegendaryRankCheat.aspx.cs" Inherits="WebManager.appaspx.stat.StatFishlordLegendaryRankCheat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script>
        seajs.use("../../Scripts/stat/StatFishlordLegendaryRankControl.js");
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal" style="padding: 20px; text-align: center">
        <h2 style="text-align: center; margin-bottom: 20px;">修改巨鲲降世/定海神针积分</h2>
        ...
        <div class="form-group">
             <label for="account" class="col-sm-2 control-label">修改类型：</label>
             <div class="col-sm-10">
                 <asp:DropDownList ID="m_editType" runat="server" CssClass="form-control"></asp:DropDownList>
             </div>
         </div>
        <div class="form-group">
        ...
        <div id="alterScore" runat="server" style="text-align: center;">
            ...
            <input id="m_param" class="col-sm-10" type="text" style="width: 60%; height: 31px;margin-left:10px;" />
