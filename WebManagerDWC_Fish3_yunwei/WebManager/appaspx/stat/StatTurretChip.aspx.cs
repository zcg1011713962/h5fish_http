...
namespace WebManager.appaspx.stat
{
    public partial class StatTurretChip : System.Web.UI.Page
    {
        ...
        private PageGenIncomeExpensesError m_gen = new PageGenIncomeExpensesError(500);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack) {
                if (m_gen.parse(Request))
                {
                    ...
                    m_playerId.Text = m_gen.m_showWay;
                    onQuery(null, null);
                }
            }
        }
        ...
        private void genTable(Table table, OpRes res, GMUser user, QueryMgr mgr, ParamQuery param)
        {
            ...
            m_gen.genPage(param, @"/appaspx/stat/StatTurretChip.aspx", ref page_html, ref foot_html, user);
