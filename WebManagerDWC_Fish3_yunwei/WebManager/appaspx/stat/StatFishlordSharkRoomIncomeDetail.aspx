<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatFishlordSharkRoomIncomeDetail.aspx.cs" Inherits="WebManager.appaspx.stat.StatFishlordSharkRoomIncomeDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  style="background-color:#ccc;width:90%;margin:0 auto; text-align:center">
        <div class="cSafeWidth">
            <h2 style="text-align:center;padding:20px;">巨鲨场玩法收入统计详情</h2>
