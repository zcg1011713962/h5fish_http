<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ShuihzDailyState.aspx.cs" Inherits="WebManager.appaspx.stat.shuihz.ShuihzDailyState" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="text-align:center;padding:20px;">水浒传每日游戏情况查看</h2>
