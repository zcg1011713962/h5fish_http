<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatWjlwGoldEarnTurnInfo.aspx.cs" Inherits="WebManager.appaspx.stat.StatWjlwGoldEarnTurnInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="background-color: #ccc; width: 90%; margin: 0 auto;text-align:center">
        <div class="cSafeWidth">
            <h2 style="padding: 20px;">金币玩法每局信息</h2>
