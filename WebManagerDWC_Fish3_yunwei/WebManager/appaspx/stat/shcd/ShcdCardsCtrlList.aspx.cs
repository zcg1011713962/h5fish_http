...
{
    public partial class ShcdCardsCtrlList : System.Web.UI.Page
    {
        ...
        {
            RightMgr.getInstance().opCheck(RightDef.SHCD_CARDS_CTRL_LIST, Session, Response);
            if (!IsPostBack)
            {
        ...
        protected void onQuery(object sender, EventArgs e)
        {
            ...
            OpRes res = user.doQuery(param, QueryType.queryTypeShcdCardsCtrlList);
        ...
        private void genTable(Table table, OpRes res, GMUser user, ParamQuery query_param)
        {
            ...
            List<killSendScoreCtrlListItem> qresult = (List<killSendScoreCtrlListItem>)user.getQueryResult(QueryType.queryTypeShcdCardsCtrlList);
            ...
            m_gen.genPage(query_param, @"/appaspx/stat/shcd/ShcdCardsCtrlList.aspx", ref page_html, ref foot_html, user);
