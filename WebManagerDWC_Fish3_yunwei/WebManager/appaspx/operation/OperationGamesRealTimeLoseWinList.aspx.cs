...
{
    public partial class OperationGamesRealTimeLoseWinList : System.Web.UI.Page
    {
        ...
        protected void onQuery(object sender, EventArgs e)
        {
            ...
            OpRes res = mgr.doQuery(param, QueryType.queryTypeGameRealTimeLoseWinRank, user);
        ...
        private void genTable(Table table, OpRes res, ParamQuery query_param, GMUser user, QueryMgr mgr)
        {
            ...
            List<MiniGameRealLoseWinRankItem> qresult = 
                (List<MiniGameRealLoseWinRankItem>)mgr.getQueryResult(QueryType.queryTypeGameRealTimeLoseWinRank);
            int i = 0, j = 0, f = 0;
            // 表头
