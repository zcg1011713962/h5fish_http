...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth" >
        <h2 style="padding:20px;text-align:center">修改登录密码</h2>
        <table style="margin:0 auto">
            <tr>
                <td>原密码：</td>
                <td>
                    <asp:TextBox ID="m_oriPwd" runat="server" CssClass="cTextBox" TextMode="Password" ClientIDMode="Static" style="height:30px;"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>密码：</td>
                <td>
                    <asp:TextBox ID="m_pwd1" runat="server" CssClass="cTextBox" TextMode="Password" ClientIDMode="Static" style="height:30px;"></asp:TextBox>
            ...
            <tr>
                <td>确认密码：</td>
                <td>
                    <asp:TextBox ID="m_pwd2" runat="server" CssClass="cTextBox" TextMode="Password" ClientIDMode="Static" style="height:30px;"></asp:TextBox>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="修改" CssClass="cButton" onclick="onModify" style="height:30px;width:120px;"/>
