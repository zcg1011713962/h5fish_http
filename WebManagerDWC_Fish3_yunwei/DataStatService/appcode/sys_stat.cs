...
class StatFishGameTimeForRoom : StatByDayBase
{
    ...
    void addRoomTime(GameRoomTime stat, DateTime time)
    {
       ...
       // data.Add("channel", stat.m_channel);
        ...
        MongodbLog.Instance.ExecuteUpdateByQuery("statPlayerPlayTime", imq, data);
    }
}
...
public class Stat100003Info
{
    ...
    public void init()
    {
        StatChannel100003_CFGData dataGold = StatChannel100003_CFG.getInstance().getValue(StatChannel100003_CFG.ID_GOLD);
        ...
        StatChannel100003_CFGData dataMoney = StatChannel100003_CFG.getInstance().getValue(StatChannel100003_CFG.ID_MONEY);
...
class StatChannel_100003 : StatByDayBase
{
    ...
    {
        int index = StatChannel100003_CFG.getInstance().getIndex(StatChannel100003_CFG.ID_GOLD, totalGold);
        for (int i = 0; i <= index; ++i)
        {
            m_statInfo.incrGoldCount(i);
        }

        index = StatChannel100003_CFG.getInstance().getIndex(StatChannel100003_CFG.ID_MONEY, money);
        for (int i = 0; i <= index; ++i)
        {
