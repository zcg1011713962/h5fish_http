...
namespace WxPayAPI
{
    ...
    public class HttpService
    {
        ...
        public static string Get(string url, Action<HttpWebRequest> cb = null, Action<Dictionary<string, object>> httpsGetData = null)
        {
            System.GC.Collect();
            string result = "";
            ...
            try
            {
                ...
                if (url.StartsWith("https", StringComparison.OrdinalIgnoreCase))
                {
                    ServicePointManager.ServerCertificateValidationCallback =
                            new RemoteCertificateValidationCallback(CheckValidationResult);
                    Dictionary<string, object> hd = new Dictionary<string, object>();
                    if(httpsGetData!=null)
                    {
                        httpsGetData(hd);
                    }
                    if (hd.ContainsKey("SecurityProtocol"))
                    {
                        ServicePointManager.SecurityProtocol = (SecurityProtocolType)hd["SecurityProtocol"];
                    }
                    else
                    {
