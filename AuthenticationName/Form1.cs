...
namespace ExportExcel
{
    public partial class Form1 : Form
    {
        ...
        private void onOpenCloseLog(object sender, EventArgs e)
        {
            CheckBase.m_isEnableLog = !CheckBase.m_isEnableLog;
            setStateText();
        }

        void setStateText()
        {
            LabelState.Text = CheckBase.m_isEnableLog ? "cur:open log" : "cur:close log";
        }
    }
}
