...
public struct RRDbNam
{
    ...
    //
    public const string RRD_DB_FISH_ROOM7 = "dbFishRoom7.rrd";

    public const string RRD_DB_FISH_ROOM8 = "dbFishRoom8.rrd";

    public const string RRD_DB_FISH_ROOM9 = "dbFishRoom9.rrd";

    public const string RRD_DB_FISH_ROOM11 = "dbFishRoom11.rrd";

    public const string RRD_DB_FISH_ROOM15 = "dbFishRoom15.rrd";
...
public class OnlineMgr
{
    ...
    void initDbName()
    {
        ...
        addName((int)(GameId.fishlord), 7, RRDbNam.RRD_DB_FISH_ROOM7);
        addName((int)(GameId.fishlord), 8, RRDbNam.RRD_DB_FISH_ROOM8);
        addName((int)(GameId.fishlord), 9, RRDbNam.RRD_DB_FISH_ROOM9);
        addName((int)(GameId.fishlord), 11, RRDbNam.RRD_DB_FISH_ROOM11);
        addName((int)(GameId.fishlord), 15, RRDbNam.RRD_DB_FISH_ROOM15);
