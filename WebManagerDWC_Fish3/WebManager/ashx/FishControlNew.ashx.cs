...
namespace WebManager.ashx
{
    ...
    public class FishControlNew : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            p.m_bigPoolPumpRate = context.Request.Form["bigPoolPumpRate"];
            p.m_bigPoolExpectedEarnRate = context.Request.Form["bigPoolExpectedEarnRate"];

            //p.m_legendaryFishRate = context.Request.Form["legendaryFishRate"];

            p.m_mythicalScoreTurnRate = context.Request.Form["mythicalScoreTurnRate"];
            p.m_mythicalFishRate = context.Request.Form["mythicalFishRate"];

            p.m_colorFishCtrCount1 = context.Request.Form["colorFishCtrCount1"];
            p.m_colorFishCtrCount2 = context.Request.Form["colorFishCtrCount2"];
            p.m_colorFishCtrRate1 = context.Request.Form["colorFishCtrRate1"];
            p.m_colorFishCtrRate2 = context.Request.Form["colorFishCtrRate2"];
