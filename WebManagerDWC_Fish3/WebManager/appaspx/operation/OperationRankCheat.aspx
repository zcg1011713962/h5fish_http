<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OperationRankCheat.aspx.cs" Inherits="WebManager.appaspx.operation.OperationRankCheat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">排行榜作弊</h2>
        <br/>
        ...
        <hr />
        <h2 style="padding:20px;text-align:center">排行榜积分修改</h2>
