<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OperationPlayerOpenRateBankruptList.aspx.cs" Inherits="WebManager.appaspx.operation.OperationPlayerOpenRateBankruptList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">玩家炮倍破产详情</h2>
