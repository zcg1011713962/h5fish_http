...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container form-horizontal">
        ...
        <div class="form-group" id="playerId">
         ...
         <div class="form-group">
            <label for="account" class="col-sm-2 control-label">变化原因：</label>
            <div class="col-sm-10">
                    <input id="m_reason" name="filter1" list="MainContent_m_reason_list" runat="server" onfocus="value=''" onclick="value = ''"
                        autocomplete="off" style="height: 35px; width: 100%; padding-left: 15px;" />
                    <datalist id = "m_reason_list" runat = "server" >
                    </datalist>    
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <asp:Button ID="Button1" runat="server" OnClick="onExport" Text="导出Excel" CssClass="btn btn-primary"  Style="width:300px;"/>
