...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">旧号变新号问题</h2>
        <div class="form-group">
            <label for="account" class="col-sm-2 control-label">老玩家ID：</label>
            <div class="col-sm-10">
                <asp:TextBox ID="m_oldPlayerId" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
            <label for="account" class="col-sm-2 control-label">新玩家ID：</label>
            <div class="col-sm-10">
                <asp:TextBox ID="m_newPlayerId" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <asp:Button ID="Button2" runat="server" Text="确定" CssClass="btn btn-primary form-control" OnClick="onModifyAcc"/>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <span id="NewMsg" style="font-size:medium;color:red" runat="server"></span>
            </div>
        </div>
    </div>
</asp:Content>
