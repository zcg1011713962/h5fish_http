<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="TdFirstRechargePointDistribution.aspx.cs" Inherits="WebManager.appaspx.td.TdFirstRechargePointDistribution" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
	...
	<script type="text/javascript">
	    ...
	    seajs.use("../../Scripts/td/TdFirstRechargePointDistribution.js?ver=1");
	</script>
    <style type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth" style="text-align:center">
        <h2 style="padding:20px;">首付计费点分布</h2>
        ...
        <br />
        <ul id="playerType" style="padding-left:40%;">
