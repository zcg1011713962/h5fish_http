<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="TdGameTimePlayerFavor.aspx.cs" Inherits="WebManager.appaspx.td.TdGameTimePlayerFavor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth" style="text-align:center">
        <h2 style="padding:20px;">平均在线游戏时间</h2>
