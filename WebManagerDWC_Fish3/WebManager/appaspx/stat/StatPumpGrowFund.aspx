<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatPumpGrowFund.aspx.cs" Inherits="WebManager.appaspx.stat.StatPumpGrowFund" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal" style="width:50%">
        <h2 style="padding:20px;text-align:center">成长基金统计</h2>
