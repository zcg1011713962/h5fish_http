<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="StatPanicBoxPlayer.aspx.cs" Inherits="WebManager.appaspx.stat.StatPanicBoxPlayer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  style="background-color:#ccc;width:90%;margin:0 auto">
        <div class="cSafeWidth">
            <h2 style="text-align:center;padding:20px;">幸运宝箱玩家列表</h2>
