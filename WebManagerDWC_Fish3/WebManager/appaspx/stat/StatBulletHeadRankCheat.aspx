<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatBulletHeadRankCheat.aspx.cs" Inherits="WebManager.appaspx.stat.StatBulletHeadRankCheat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">欢乐/衰神炸炸炸作弊</h2>
        <br/>
        ...
        <hr />
        <h2 style="padding:20px;text-align:center">欢乐/衰神炸炸炸积分修改</h2>
