...
{
    public partial class StatFishlordAdvancedRoomCheatCtrl : System.Web.UI.Page
    {
        ...
        {
            m_res.InnerHtml = "";
            RightMgr.getInstance().opCheck(RightDef.FISH_LORD_ADVANCED_ROOM_CHEAT_CTRL, Session, Response);
        }
        ...
        protected void onQuery(object sender, EventArgs e)
        {
            ...
            OpRes res = mgr.doQuery(p, QueryType.queryTypeStatFishlordAdvancedRoomScore, user);
        ...
        private void genTable(Table table, OpRes res, GMUser user, QueryMgr mgr)
        {
            ...
            List<StatFishlordAdvancedRoomActRankItem> qresult =
                (List<StatFishlordAdvancedRoomActRankItem>)mgr.getQueryResult(QueryType.queryTypeStatFishlordAdvancedRoomScore);
            int i = 0, j = 0, f = 0;
            // 表头
        ...
        protected void onEdit(object sender, EventArgs e)
        {
            ...
            }else
            {
                ...
                else
                {
                    ...
                    CommandBase cmd = CommandMgr.processCmd(CmdName.AlterFishlordAdvancedRoomPlayerScore, buffer, user);
                    res = cmd.getOpRes();
