<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatPumpHuntFishRechargeActFortuneStar.aspx.cs" Inherits="WebManager.appaspx.stat.StatPumpHuntFishRechargeActFortuneStar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  style="background-color:#ccc;width:90%;margin:0 auto;text-align:center">
        <div class="cSafeWidth">
            <h2 style="text-align:center;padding:20px;">福运之星兑换详情</h2>
