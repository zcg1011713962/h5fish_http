...
{
    public partial class StatTurretlotteryActivity : System.Web.UI.Page
    {
        ...
        static StatTurretlotteryActivity()
        {
        ...
        {
            RightMgr.getInstance().opCheck(RightDef.DATA_STAT_TURRET_LOTTERY, Session, Response);
        ...
        protected void onQuery(object sender, EventArgs e)
        {
            ...
            OpRes res = user.doQuery(param, QueryType.queryTypeTurretLotteryActivity);
        ...
        private void genTable(Table table, OpRes res, GMUser user)
        {
            ...
            List<TurretLotteryActInfo> qresult = (List<TurretLotteryActInfo>)user.getQueryResult(QueryType.queryTypeTurretLotteryActivity);
