<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatActivityFishingCelebration.aspx.cs" Inherits="WebManager.appaspx.stat.StatActivityFishingCelebration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal" style="width:80%">
        <h2 style="padding:20px;text-align:center">庆典活动统计</h2>
        <div class="form-group">
            <label for="account" class="col-sm-4 control-label">统计项目:</label>
            <div class="col-sm-2">
        ...
        <div class="form-group">
            <label for="account" class="col-sm-4 control-label">时间：</label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            <label for="account" class="col-sm-6 control-label"></label>
            <asp:Button ID="Button1" runat="server" Text="确定" onclick="onQuery" CssClass="btn btn-primary col-sm-2"/>
        </div>    
