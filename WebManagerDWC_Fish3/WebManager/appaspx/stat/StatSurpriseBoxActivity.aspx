<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatSurpriseBoxActivity.aspx.cs" Inherits="WebManager.appaspx.stat.StatSurpriseBoxActivity" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <link rel="stylesheet" type="text/css" media="all" href="../../Scripts/datepicker/daterangepicker.css" />
    <script src="../../Scripts/stat/StatSurpriseBox.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container form-horizontal" style="width:50%">
        <h2 style="padding:20px;text-align:center">惊喜盒统计</h2>
        ...
        <asp:Button ID="Button1" runat="server" Text="确定" onclick="onQuery" CssClass="btn btn-primary" style="width:40%;margin-left:40%"/>
        <br/>
        <br/>
     </div>
