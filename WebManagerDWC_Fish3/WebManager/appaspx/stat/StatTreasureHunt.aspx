<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatTreasureHunt.aspx.cs" Inherits="WebManager.appaspx.stat.StatTreasureHunt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal" style="width:50%">
        <h2 style="padding:20px;text-align:center">南海寻宝</h2>
        <div class="form-group">
            <label for="account"  class="col-sm-2 control-label">玩家ID：</label>
            <div class="col-sm-10">
                <asp:TextBox ID="m_playerList" runat="server" CssClass="form-control" placeholder="输入多个玩家ID时，以逗号隔开（如：10001,10002,10003）；不输入玩家ID，查询全部"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
            <label for="account" class="col-sm-2 control-label">场次：</label>
            <div class="col-sm-10">
                <asp:DropDownList ID="m_roomList" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>
        </div>
        <div class="form-group">
