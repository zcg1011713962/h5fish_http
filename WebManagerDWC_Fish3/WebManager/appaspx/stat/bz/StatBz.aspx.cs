...
{
    public partial class StatBz : System.Web.UI.Page
    {
        ...
        {
            RightMgr.getInstance().opCheck(RightDef.BZ_PARAM_CONTROL, Session, Response);
        ...
        protected void onModifyExpRate(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                OpRes res = mgr.doDyop(p, DyOpType.opTypeBzParamAdjust, user);
        ...
        protected void genExpRateTable(Table table)
        {
            ...
            OpRes res = mgr.doQuery(null, QueryType.queryTypeBzParam, user);
            Dictionary<int, ResultFishlordExpRate> qresult
                = (Dictionary<int, ResultFishlordExpRate>)mgr.getQueryResult(QueryType.queryTypeBzParam);
