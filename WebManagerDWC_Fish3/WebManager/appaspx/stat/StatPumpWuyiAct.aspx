<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatPumpWuyiAct.aspx.cs" Inherits="WebManager.appaspx.stat.StatPumpWuyiAct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       <div class="container form-horizontal">
         <h2 style="padding:20px;text-align:center">冬季嘉年华</h2>
        <%--<h2 style="padding:20px;text-align:center">五一活动统计2020</h2>--%>
