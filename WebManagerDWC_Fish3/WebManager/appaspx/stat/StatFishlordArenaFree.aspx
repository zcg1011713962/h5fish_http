<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatFishlordArenaFree.aspx.cs" Inherits="WebManager.appaspx.StatFishlordArenaFree" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal" style="width:80%">
        <h2 style="padding:20px;text-align:center">自由赛</h2>
        ...
        <div class="form-group">
            <label for="account" class="col-sm-2 control-label">自由赛类型:</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <asp:DropDownList ID="m_timeRange" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>
        </div>
