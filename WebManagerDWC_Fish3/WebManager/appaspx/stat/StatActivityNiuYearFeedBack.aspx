<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatActivityNiuYearFeedBack.aspx.cs" Inherits="WebManager.appaspx.stat.StatActivityNiuYearFeedBack" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container form-horizontal" style="width:40%">
        <h2 style="padding:20px;text-align:center">牛年大回馈活动统计</h2>
