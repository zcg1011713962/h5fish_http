<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatDragonScaleControl.aspx.cs" Inherits="WebManager.appaspx.stat.StatDragonScaleControl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script>
        seajs.use("../../Scripts/stat/StatDragonScaleControl.js");
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal" style="padding: 20px; text-align: center">
        <h2 style="text-align: center; margin-bottom: 20px;">修改玩家魔石积分</h2>
        <h2 style="height: 40px; line-height: 40px; background-color: #ccc; padding: 0 50px;">修改魔石积分提示：
                修改魔石积分时，需要先下线。等待超过7分钟再上线，才能确保服务器的数据不会覆盖修改后的数据。
        </h2>
        <br />
        <br />
        ...
        <div class="form-group" id="alterScore" runat="server" style="text-align: center;">
            <span style="font-weight: bold;" class="col-sm-2 control-label">修改玩家魔石积分数：</span>
            <input id="m_param" class="col-sm-10" type="text" style="width: 60%; height: 31px;margin-left:20px;" />
            <input id="btnConfirm" type="button" class="btn btn-primary form-control" value="确定" style="width: 225px;" /><br />
