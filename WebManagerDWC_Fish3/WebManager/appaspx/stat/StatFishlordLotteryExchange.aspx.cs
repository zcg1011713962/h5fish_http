...
namespace WebManager.appaspx.stat
{
    public partial class StatFishlordLotteryExchange : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                m_roomId.Items.Add(new ListItem("全部", "0"));
                m_roomId.Items.Add(new ListItem("初级场", "1"));
                m_roomId.Items.Add(new ListItem("中级场", "2"));
                m_roomId.Items.Add(new ListItem("高级场", "3"));
                m_roomId.Items.Add(new ListItem("圣兽场", "9"));
            }
        }
