<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatPumpRedEnvelopExchange.aspx.cs" Inherits="WebManager.appaspx.stat.StatPumpRedEnvelopExchange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">红包方案兑换</h2>
