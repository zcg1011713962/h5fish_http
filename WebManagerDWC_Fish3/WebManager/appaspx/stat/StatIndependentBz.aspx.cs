...
{
    public partial class StatIndependentBz : System.Web.UI.Page
    {
        ...
        {
            RightMgr.getInstance().opCheck(RightDef.BZ_INDEPEND_DATA, Session, Response);
        }
        ...
        protected void onStat(object sender, EventArgs e)
        {
            ...
            OpRes res = mgr.doQuery(null, QueryType.queryTypeIndependentBz, user);
        ...
        private void genTable(Table table, OpRes res, GMUser user, QueryMgr mgr)
        {
            ...
            ResultBz qresult = (ResultBz)mgr.getQueryResult(QueryType.queryTypeIndependentBz);
