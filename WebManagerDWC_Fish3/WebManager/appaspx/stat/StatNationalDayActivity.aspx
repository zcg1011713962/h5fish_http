<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="StatNationalDayActivity.aspx.cs" Inherits="WebManager.appaspx.stat.StatNationalDayActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container form-horizontal">
        <h2 style="padding:20px;text-align:center">国庆节活动</h2>
        ...
        <div class="form-group"id="killCount">
            <label for="account" class="col-sm-2 control-label">击杀数量：</label>
            <div class="col-sm-10">
                <asp:TextBox ID="m_fishCount" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
