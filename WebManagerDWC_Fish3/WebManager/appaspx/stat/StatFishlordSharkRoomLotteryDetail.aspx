<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatFishlordSharkRoomLotteryDetail.aspx.cs" Inherits="WebManager.appaspx.stat.StatFishlordSharkRoomLotteryDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  style="background-color:#ccc;width:90%;margin:0 auto; text-align:center">
        <div class="cSafeWidth" style="width:90%">
            <h2 style="text-align:center;padding:20px;">巨鲨场抽奖统计详情</h2>
