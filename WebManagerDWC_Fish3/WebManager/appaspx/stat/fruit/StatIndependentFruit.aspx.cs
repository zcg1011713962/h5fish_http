...
{
    public partial class StatIndependentFruit : System.Web.UI.Page
    {
        ...
        {
            RightMgr.getInstance().opCheck(RightDef.FRUIT_INDEPEND_DATA, Session, Response);
        }
        ...
        protected void onStat(object sender, EventArgs e)
        {
            ...
            OpRes res = mgr.doQuery(null, QueryType.queryTypeIndependentFruit, user);
        ...
        private void genTable(Table table, OpRes res, GMUser user, QueryMgr mgr)
        {
            ...
            ResultFruit qresult = (ResultFruit)mgr.getQueryResult(QueryType.queryTypeIndependentFruit);
