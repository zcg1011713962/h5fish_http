$(function () {
    ...
    $("#btnConfirm").click(function () {
        ...
        var m_op = $("#MainContent_m_editType").get(0).selectedIndex;
        ...
        $.ajax({
            type: "POST",
            url: "/ashx/FishlordLegendaryCheatScore.ashx",
            data: { 'playerId': m_playerId, 'scoreParam': m_param, 'op': m_op, 'nickname': m_nickName },
