...
public struct DefCC
{
    ...
    //福运之星
    public const string ASPX_STAT_PUMP_HUNT_FISH_RECHARGE_ACT_FORTUNE_STAR = "/appaspx/stat/StatPumpHuntFishRechargeActFortuneStar.aspx";

    //////////////////////////////////////////////
    // 当前排行
    public const int QRY_RANK_CUR = 1;
    // 历史排行
    public const int QRY_RANK_HISTORY = 2;
    // 抽奖
    public const int QRY_LOTTERY = 3;

    public const int ROBOT_MIN_ID = 10099001;
    public const int ROBOT_MAX_ID = 10099200;

    public const string PWD_EXT = "&@*(#kas9581gajk";
}
...
public enum QueryType
{
    //奖券场活动统计
    //奖券场
    queryTypeStatFishlordTicketRoomStat,

    //每日挑战
    queryTypeStatFishlordTicketRoomQuest,

    //活动时间管理
    queryTypeOperationActivityCFGNew,

    //魔石达人统计
    queryTypeStatPumpDimensitySlayer,

    //捕鱼大奖赛排行榜 
    //当日排行 赛季排行
    queryTypeStatFishlordGrandPrixActDailyRank,

    //历史排行 历史赛季排行
    queryTypeStatFishlordGrandPrixActHisDailyRank,

    //捕鱼大奖赛排行作弊
    queryTypeStatFishlordGrandPrixActCheat,

    //圣兽场打点
    queryTypeStatMythicalBossPoint,

    //巨鲨场打点
    queryTypeStatSharkRoomBombPoint,

    //聚宝鱼统计
    queryTypeStatTreasureBowlPoint,

    //魔鲲场统计
    queryTypeStatLegendaryFishRoomPoint,

    //数据查询
    queryTypeStatChannelTalkingDataWeek,

    //幸运转盘统计
    queryTypeStatWelFareLottery,
    ...
    //新手返利
    queryTypeStatGrowthRechargeTaskRebate,

    //新手转盘
    queryTypeStatGrowthRechargeTaskGift,

    //新手成就
    queryTypeStatGrowthAchieveTask,
    ...
    //福运之星
    queryTypeStatPumpFortuneStar,

    //福运之星详情
    queryTypeStatPumpFortuneStarDetail,
    ...
    //历史
    queryTypeStatFishlordGoldHoopTorpedoHisRank,
    ...
    // 鲲蛋鱼统计
    queryTypeStatFishlordLegendaryFishRoomCoin,

    //魔鲲商店
    queryTypeStatFishlordLegendaryFishRoomShop,
    ...
    //炮倍基金
    queryTypeStatPumpPaoGrowthFund,

    //等级基金
    queryTypeStatPumpLevelGrowthFund,
    ...
    queryTypeFishArena,
    // 炮台兑换活动
    queryTypeExchangeActivity,
    // 炮台抽奖活动
    queryTypeTurretLotteryActivity,
    // 限时购活动
    queryTypeLimitTimeBuyActivity,
    // 积分送大奖
    queryTypeIntScoreSendAward,

    queryTypeBreakEgg,
    queryTypeSummerDay,
    queryTypeDanGrade,
    queryTypeFishArenaFree,
    queryTypeKillDemons,
    queryTypeSailingFestival,
    queryTypeD11Activity,

    // 王者争霸
    queryTypeKingCraft,

    queryTypeTouchFish,
    queryFishCelebration,
    queryNiuYearFeedBack,
}
