...
public struct RightDef
{
    ...
    public const string OP_STAT_CHANNEL_TALKING_DATA_WEEK = "35"; //数据查询
    public const string OP_ACTIVITY_CFG_NEW = "36";//活动时间配置
    public const string OP_EXCHANGE_SETTING = "37";//兑换道具数量设置
    ...
    public const string SVR_ROBOT_INFO = "1020";            //机器人信息
    ...
    public const string DATA_STAT_WEL_FARE_LOTTERY = "3098"; //幸运转盘统计
    public const string DATA_STAT_ROOM_POINT = "3099"; //场次打点统计
    public const string DATA_STAT_FISHLORD_GRAND_PRIX_ACT = "3100"; //捕鱼大奖赛排行榜
    public const string DATA_STAT_FISHLORD_GRAND_PRIX_ACT_CHEAT = "3101"; //捕鱼大奖赛排行榜作弊
    public const string DATA_STAT_PUMP_DIMENSITY_SLAYER = "3102"; //魔石达人统计
    public const string DATA_STAT_FISHLORD_TICKET_ROOM_ACT = "3103"; //奖券场活动统计
    public const string DATA_STAT_INT_SCORE_SEND = "3104"; // 积分送大奖
    public const string DATA_STAT_LIMIT_TIME_BUY = "3105"; // 限时购
    public const string DATA_STAT_FISHLORD_ARENA = "3106"; // 竞技赛统计
    public const string DATA_STAT_TURRET_LOTTERY = "3107"; // 炮台抽奖活动
    public const string DATA_STAT_TURRET_EXCHANGE = "3108"; // 炮台兑换活动
    public const string DATA_STAT_ROBOT_CHEAT = "3109"; // 机器人作弊
    public const string DATA_STAT_BREAK_EGG = "3110"; // 砸蛋统计
    public const string DATA_STAT_SUMMER_DAY = "3111"; // 夏日狂欢
    public const string DATA_STAT_DAN_GRADING = "3112"; // 段位赛
    public const string DATA_STAT_KILL_MONSTER = "3113"; // 猎妖塔
    public const string DATA_STAT_SAILING_FES = "3114"; // 启航盛典
    public const string DATA_STAT_D11 = "3115"; // 双11
    public const string DATA_STAT_KING_CRAFT = "3116"; // 王者争霸
    public const string DATA_STAT_TOUCH_FISH = "3117"; // 摸鱼
    public const string DATA_STAT_FISH_CELE = "3118"; // 庆典活动
    public const string DATA_STAT_FEED_BACK = "3119"; // 牛年回馈活动
    public const string DATA_STAT_SUMMER_PLAN = "3120"; // 夏日计划
    public const string DATA_STAT_SURPRISE_BOX = "3121"; // 惊喜盒
    public const string DATA_STAT_LINGBAO = "3122"; // 灵宝抽奖统计
    ...
    public const string PLAYER_VIP_INFO = "100002"; //玩家VIP信息
