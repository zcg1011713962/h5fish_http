...
public struct CmdName
{
    ...
    //捕鱼大奖赛作弊
    public const string AlterFishlordGrandPrixActPlayerScore = "StatFishlordGrandPrixActPlayerScoreEdit";
}
...
public class CmdFactorySet
{
    ...
    public void init()
    {
        ...
        m_dic.Add(CmdName.AlterFishlordGrandPrixActPlayerScore, new CmdFactoryStatFishlordGrandPrixActPlayerScoreAlter()); //捕鱼大奖赛排行榜作弊
...
public class CmdFactoryStatFishlordGrandPrixActPlayerScoreAlter : CmdFactoryBase 
{
    public override CommandBase createCMD()
    {
        return new CommandFishlordGrandPrixActPlayerScoreEdit();
    }
}
