...
public class CleanDataMgr : SysBase
{
    ...
    public override void init()
    {
        ...
        addData(TableName.STAT_FISHLORD_MIDDLE_ROOM_RANK, "genTime", DbName.DB_GAME, 8);
        addData(TableName.FISHLORD_ADVANCED_ROOM_ACT_RANK_HIS, "genTime", DbName.DB_GAME, 8);
        addData(TableName.STAT_PUMP_LEGENDARY_FISH_ROOM_RANK, "genTime", DbName.DB_GAME, 8);
        addData(TableName.STAT_FISHLORD_SHARK_RANK, "genTime", DbName.DB_GAME, 8);
        addData(TableName.STAT_PUMP_MYTHICAL_ROOM_RANK, "genTime", DbName.DB_GAME, 8);
        addWeekData("pumpDragonRoomRank", "weekCount", DbName.DB_PUMP, 8, getCurWeekCount);
        addData("global_activity_cfg", "endTime", DbName.DB_PLAYER, 3);
    }
