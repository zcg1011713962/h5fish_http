...
public class ExportMgr
{
    ...
    public void init()
    {
        ...
        // 充值用户统计
        m_tables.Add(TableName.PUMP_RECHARGE_PLAYER_NEW, new ExportRechargePlayer());
        // 充值玩家监控
        ...
        m_tables.Add(TableName.EXCHANGE, new ExportExchange());
        ...
        //vip玩家信息导出
        m_tables.Add(ExportVipPlayerInfo.TABLE_NAME, new ExportVipPlayerInfo());
		//玩家道具获取详情
        m_tables.Add(ExportPlayerItemRecord.TABLE_NAME_PLAYER_ITEM, new ExportPlayerItemRecord());
