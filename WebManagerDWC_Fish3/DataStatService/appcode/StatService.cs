...
public class StatService : ServiceBase
{
    ...
    public override void initService()
    {
      ...
      //  m_sysMgr.addSys(new StatOnlinePlayerNumPerHour(), SysType.systype_OnlinePlayerNumHour);
        ...
        m_sysMgr.addSys(new StatFishGameTimeForRoom(), SysType.systype_FishGameTimeForRoom);
      //  m_sysMgr.addSys(new StatFirstRecharge(), SysType.systype_FirstRecharge);
       ...
       // m_sysMgr.addSys(new StatPersonTimeGlobalDay(), SysType.systype_PersonTimeGlobalDay);
     //   m_sysMgr.addSys(new StatStarLottery(), SysType.systype_StarLottery);
      //  m_sysMgr.addSys(new StatStarLotteryDetail(), SysType.systype_StarLotteryDetail);
     //   m_sysMgr.addSys(new StatLabaLottery(), SysType.systype_LabaLottery);
     //   m_sysMgr.addSys(new StatBaoJin(), SysType.systype_Baojin);
     //   m_sysMgr.addSys(new StatPuppet(), SysType.systype_Puppet);
        //m_sysMgr.addSys(new StatRechargePoint(), SysType.systype_RechargePoint);
     //   m_sysMgr.addSys(new StatOldPlayerLogin(), SysType.systype_OldPlayerLogin);
     //   m_sysMgr.addSys(new StatSign(), SysType.systype_Sign);
     //   m_sysMgr.addSys(new StatRechargeAibei(), SysType.systype_RechargeAibei);
        m_sysMgr.addSys(new StatOnlinePlayerNumRRd(), SysType.systype_OnlinePlayerNumHourRRd);
     //   m_sysMgr.addSys(new StatBaojinJoinDistribute(), SysType.systype_StatBaojinJoinDistribute);
     //   m_sysMgr.addSys(new StatNYGift(), SysType.systype_NYGift);
     //   m_sysMgr.addSys(new StatWuyiRechargeLottery(), SysType.systype_WuyiRechargeLottery);
     //   m_sysMgr.addSys(new StatPanicBox(), SysType.systype_PanicBox);
        m_sysMgr.addSys(new StatDragonPalaceDistribute(), SysType.systype_DragonPalace);
        m_sysMgr.addSys(new StatItemBuy(), SysType.systype_StatItemBuy);
        m_sysMgr.addSys(new StatNewPlayerTurretGameTime(), SysType.systype_StatNewPlayerTurretGameTime);
        m_sysMgr.addSys(new StatVipRecord(), SysType.systype_StatVipRecord);
        m_sysMgr.addSys(new StatTurretItems(), SysType.systype_StatTurretItems);
        m_sysMgr.addSys(new StatPlayerWithGold(), SysType.systype_StatPlayerWithGold);
        m_sysMgr.addSys(new StatPlayerExchange(), SysType.systype_StatPlayerExchange);
        m_sysMgr.addSys(new StatChannel_100003(), SysType.systype_StatChannel_100003);
        m_sysMgr.addSys(new StatChannel_100009(), SysType.systype_StatChannel_100009);
        m_sysMgr.addSys(new StatChannel_100010(), SysType.systype_StatChannel_100010);
        m_sysMgr.addSys(new StatChannel_100011(), SysType.systype_StatChannel_100011);
        m_sysMgr.addSys(new StatChannel_100012(), SysType.systype_StatChannel_100012);
        m_sysMgr.addSys(new StatChannel_100013(), SysType.systype_StatChannel_100013);
        m_sysMgr.addSys(new StatChannel_100014(), SysType.systype_StatChannel_100014);
        m_sysMgr.addSys(new StatChannel_100015(), SysType.systype_StatChannel_100015);
        m_sysMgr.addSys(new StatChannel_100016(), SysType.systype_StatChannel_100016);

        m_sysMgr.addSys(new StatChannelWeek(), SysType.systype_StatChannelWeek);
        m_sysMgr.addSys(new StatTouchFishPlayerDistri(), SysType.systype_StatTouchFishPlayerDistri);

        //   m_sysMgr.addSys(new StatNationDay2018(), SysType.systype_NationalDay2018);
...
public class StatBase
{
    ...
    public static bool canStat(ChannelInfo param) 
    {
        ...
        if (now >= param.m_statDay.Date.AddMinutes(5))
            return true;
