...
public struct TableName
{
    //奖券场活动统计
    //奖券场统计
    public const string STAT_PUMP_TICKET_ROOM = "pumpTicketRoom";
    //每日挑战
    public const string STAT_PUMP_TICKET_ROOM_QUEST = "pumpTicketRoomQuest";

    //活动时间设置
    public const string GLOBAL_ACTIVITY_CFG = "global_activity_cfg";

    //魔石达人统计
    public const string STAT_PUMP_DIMENSITY_SLAYER = "pumpDimensitySlayer";

    //捕鱼大奖赛排行榜
    //今日排行 赛季
    public const string STAT_GRAND_PRIX_ACTIVITY = "grandprix_activity";
    //历史今日/赛季排行
    public const string STAT_GRAND_PRIX_DAILY_RANK = "grandprixDailyRank";
    public const string STAT_GRAND_PRIX_SEASON_RANK = "grandprixSeasonRank";

    //圣兽场打点
    public const string STAT_PUMP_MYTHICAL_BOSS = "pumpMythicalBoss";

    //巨鲨场打点
    public const string STAT_PUMP_SHARK_ROOM_BOMB_POINT = "pumpSharkRoomBombPoint";

    //聚宝鱼统计
    public const string STAT_PUMP_TREASURE_BOWL = "pumpTreasureBowl";

    //魔鲲场统计
    public const string STAT_PUMP_LEGENDARY_FISH_ROOM_DETAIL = "pumpLegendaryFishRoomDetail";

    //礼包触发次数
    public const string STAT_PUMP_TRIGGER_BROKEN_GIFT = "pumpTriggerBrokenGift";

    //数据查询
    public const string STAT_CHANNEL_TALKING_DATA_WEEK = "channelTalkingDataWeek";

    //幸运转盘统计
    public const string STAT_PUMP_WEL_FARE_LOTTERY = "pumpWelFareLotter";
    ...
    //新手返利
    public const string STAT_PUMP_GROWTH_RECHARGE_TASK = "pumpGrowthRechargeTask";

    //新手成就
    public const string STAT_PUMP_GROWTH_ACHIEVE_TASK = "pumpGrowthAchieveTask";
    ...
    //历史排行榜
    public const string STAT_PUMP_MYTHICAL_ROOM_RANK = "fishlordMythicalRoomRank";
    ...
    //public const string STAT_PUMP_WUYI_TASK = "pumpDuanwuTask";
    public const string STAT_PUMP_WUYI_TASK = "pumpSummerTask";
    public const string PUMP_SUMMER_SIGN = "pumpSummerSign";

    //五一宝库
    //public const string STAT_PUMP_WUYI_LOTTERY = "pumpWuYiLottery";
    //public const string STAT_PUMP_WUYI_LOTTERY = "pumpDuanwuLottery";
    public const string STAT_PUMP_WUYI_LOTTERY = "pumpSummerLottery";
    ...
    //福运之星
    public const string STAT_PUMP_FORTUNE_STAR = "pumpFortuneStar";
    //福运之星 详情
    public const string STAT_PUMP_FORTUNE_STAR_DETAIL = "pumpFortuneStarDetail";
    ...
    //历史
    public const string STAT_PUMP_LEGENDARY_FISH_ROOM_RANK = "fishlordLegendaryFishRoomRank";
    ...
    // 追击蟹将活动
    public const string ACTIVITY_KILL_CRAB = "fishlordActivityKillCrabPlayer";
    // 追击蟹将活动历史榜
    public const string ACTIVITY_KILL_CRAB_RANK = "fishlordActivityKillCrabRank";
    ...
    //高级场排行榜历史
    public const string FISHLORD_ADVANCED_ROOM_ACT_RANK_HIS = "fishlordAdvancedRoomRank";
    ...
    //中级场历史排行榜
    public const string STAT_FISHLORD_MIDDLE_ROOM_RANK = "fishlordMiddleRoomRank";
    ...
    public const string STAT_FISHLORD_SHARK_RANK = "fishlordArmedSharkRoomRank";
   ...
   //世界杯大竞猜赛事竞猜
    ...
    public const string PUMP_BULLET_HEAD_RANK = "TorpedoRank";
    ...
    //龙鳞排行
    public const string FISHLORD_DRAGON_PALACE_RANK = "fishlordDragonRoomRank";
    ...
    // 竞技场玩家
    public const string ARENA_MATCH_PLAYER = "arenaMatchPlayer";
    // 竞技场历史日榜
    public const string ARENA_RANK_DAY_HISTORY = "arenaMatchDayRank";
    // 竞技场历史周榜
    public const string ARENA_RANK_WEEK_HISTORY = "arenaMatchWeekRank";
    // 竞技场统计
    public const string PUMP_ARENA_STAT = "pumpArenaMatchEnter";
    // 竞技场统计详细
    public const string PUMP_ARENA_STAT_DETAIL = "pumpArenaMatchEnterDetail";
    // 自由赛当日
    public const string ARENA_FREE_MATCH_PLAYER = "freedomMatchPlayer";
    // 自由赛历史榜
    public const string ARENA_FREE_RANK_HISTORY = "freedomMatchRank";
    // 自由赛统计
    public const string PUMP_ARENA_FREE_STAT = "pumpFreedomMatchEnter";
    // 自由赛统计详细
    public const string PUMP_ARENA_FREE_STAT_DETAIL = "pumpFreedomMatchEnterDetail";

    // 段位赛
    public const string PUMP_DAN_GRADING = "pumpQualifyingSys";
    // 段位赛当前活动
    public const string ACTIVITY_DAN_GRADING = "qualifying_activity";
    // 段位赛历史排行
    public const string ACTIVITY_DAN_GRADING_RANK = "qualifyingRank";

    // 积分送大奖抽奖
    public const string PUMP_INT_SCORE_SEND_AWARD_LOTTERY = "pumpPersonalTailorLottery";
    // 积分送大奖当前排行
    public const string ACTIVITY_INT_SCORE_RANK_CUR = "personalTailorActivity";
    // 积分送大奖历史排行
    public const string PUMP_INT_SCORE_RANK_HISTORY = "pumpPersonalTailorRank";

    // 砸蛋统计-当前排行
    public const string ACTIVITY_BREAK_EGG = "smashingEggsActivity";
    // 砸蛋统计-历史排行
    public const string PUMP_BREAK_EGG_RANK = "pumpSmashingEggsRank";
    // 砸蛋统计
    public const string PUMP_BREAK_EGG_LOTTERY = "pumpSmashingEggs";

    // 夏日狂欢统计-当前排行
    public const string ACTIVITY_SUMMERDAY = "summerRevelsActivity";
    // 夏日狂欢统计-历史排行
    public const string PUMP_SUMMERDAY_RANK = "pumpSummerRevelsRank";
    // 夏日狂欢统计-抽奖
    public const string PUMP_SUMMERDAY_LOTTERY = "pumpSummerRevels";

    public const string EXCHANGE_SETTING = "exchangeSetting";
    ...
    public const string CHANNEL_TD_WEEK = "channelTalkingDataWeek";
    ...
    // 炮台兑换活动
    public const string PUMP_EXCHANGE_ACTIVITY = "pumpItemCompose";
    // 炮台抽奖活动
    public const string PUMP_TURRET_LOTTERY_ACTIVITY = "pumpTurretLottery";
    // 限时购活动
    public const string PUMP_LIMIT_TIME_ACTIVITY = "pumpTimeLimitPurchase";

    //////////////////////////////////////////////////////////////////////////
    // 猎妖塔任务统计
    public const string PUMP_KILL_MONSTER_QUEST = "pumpKillDemonsQuest";
    // 神兽统计
    public const string PUMP_KILL_MONSTER_MONSTER = "pumpKillDemonsDemons";
    // 法宝
    public const string PUMP_KILL_MONSTER_WEAPON = "pumpKillDemonsWeapon";
    // 斩妖剑
    public const string PUMP_KILL_MONSTER_SWORD = "pumpKillDemonsSword";
    public const string KILL_MONSTER_ACTIVITY = "killDemonsActivity";
    public const string PUMP_KILL_MONSTER_RANK = "pumpKillDemonsRank";

    // 大圣场当日
    public const string FISHLORD_ADVANCED_DAILY_PLAYER = "fishlordAdvancedDailyPlayer";
    // 大圣场当周
    public const string FISHLORD_ADVANCED_WEEKLY_PLAYER = "fishlordAdvancedWeeklyPlayer";
    public const string FISHLORD_ADVANCED_DAILY_PLAYER_RANK = "fishlordAdvancedDailyRoomRank";
    public const string FISHLORD_ADVANCED_WEEK_PLAYER_RANK = "fishlordAdvancedWeeklyRoomRank";

    // 启航盛典
    public const string PUMP_SAIL_FESTIVAL = "pumpSailCeremony";

    public const string PUMP_D11_TASK = "pumpDoubleEleven";
    public const string D11_ACT = "doubleElevenActivityPlayer";
    public const string PUMP_D11_RANK = "pumpDoubleElevenRank";

    public const string PUMP_KING_CRAFT = "pumpKingCraft";
    public const string ACT_KING_CRAFT = "kingCraftActivity";
    public const string PUMP_KING_CRAFT_HISTORY_RANK = "pumpKingCraftRank";

    public const string ACTIVITY_TOUCH_FISH = "touchingFishActivity";
    public const string PUMP_TOUCH_FISH = "pumpTouchingFishRank";
    public const string PUMP_TOUCH_FISH_GIFT = "pumpTouchingFishGift";
    public const string PUMP_TOUCH_FISH_PLAYER_DISTRI = "pumpTouchingFishPlayerDistribution";
    public const string STAT_TOUCH_FISH_PLAYER_DISTRI = "statTouchingFishPlayerDistribution";
    public const string PUMP_TOUCH_FISH_PLAYER_TASK = "pumpTouchingFishPlayerTask";

    public const string PUMP_FISHING_CELE_STATE = "pumpFishingCelebrationState";
    public const string PUMP_FISHING_CELE = "pumpFishingCelebration";
    public const string PUMP_FISHING_CELE_RANK = "fishingCelebrationActivityPlayer";

    public const string PUMP_FEED_BACK_PRIZE = "pumpFeedBackPrize";

    // 计划激活 夏日计划
    public const string PUMP_SUMMER_PLAN = "pumpSummerPlan";
    public const string PUMP_SUMMER_PLAN_BALANCE = "pumpSummerPlanBalance";

    public const string PUMP_SURPRISE_BOX = "pumpHappySummer";
    public const string ACTIVITY_SURPRISE_BOX = "happySummerActivity";

    // 灵宝抽奖统计
    public const string PUMP_LINGBAO = "pumpDragonBallLottery";
    ...
    public const string STAT_CHANNEL100009 = "statChannelPlayer100009";
    public const string STAT_CHANNEL100010 = "statChannelPlayer100010";
    public const string STAT_CHANNEL100011 = "statChannelPlayer100011";
    public const string STAT_CHANNEL100012 = "statChannelPlayer100012";
    public const string STAT_CHANNEL100013 = "statChannelPlayer100013";
    public const string STAT_CHANNEL100014 = "statChannelPlayer100014";
    public const string STAT_CHANNEL100015 = "statChannelPlayer100015";
    public const string STAT_CHANNEL100016 = "statChannelPlayer100016";
}
...
public static class StrName
{
    ...
    public static string[] s_fishLordRoomName = { "初级场", "巨鳄场", "大圣场", "VIP专场","竞技场","至尊场","东海龙宫场"};
    ...
    {
        if (s_roomList.ContainsKey(roomId))
        {
            return s_roomList[roomId];
        }
        return "";
    }
    ...
    static StrName()
   {
       ...
       s_roomList.Add((int)RoomId.room10, "聚宝金龟场");
       s_roomList.Add((int)RoomId.room11, "竞技赛渔场");
   ...
   public static string getGameName3(int key) 
   {
    ...
    public static string getPropertyName(int propertyType)
    {
        ...
        if (propertyType == (int)PropertyType.property_type_hongbao)
            return "红包";

        if (propertyType == (int)PropertyType.property_type_caiquan)
            return "彩券";

        if (propertyType == (int)PropertyType.property_type_yuanbao)
            return "金元宝";

        if (propertyType == (int)PropertyType.property_type_dragon_ball)
            return "龙珠";

        if (propertyType == (int)PropertyType.property_type_shuijing)
            return "荣耀水晶";
...
public enum PropertyType
{
    ...
    //彩券
    property_type_caiquan = 202,

    //金元宝
    property_type_yuanbao = 203,

    // 荣耀水晶
    property_type_shuijing = 109,
...
public class ResultRPlayerItem
{
    ...
    public long m_remainGold;
    public long m_mostGold;
